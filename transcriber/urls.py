...
urlpatterns = [
    ...
    path('translate/<int:transcription_id>/', views.translate_transcription, name='translate_transcription'),
    ...
    path('translate/<int:transcription_id>/', views.translate_transcription, name='translate'),
]
